...
class NavigationUtil {
  static RouteConfig resolveRouteToWidget(
      String route, Map<String, dynamic> routerMap) {
    print("in resolve routetowidget Route ==> $route");
    var urlsegments =
        route.split("?"); //split to see if are any query parameters
    ...
    RouteConfig routeConfig = RouteConfig(
        ...
        routeCallBackFunction: callBackFunction,
        isUnknownRoute: (matchedRouteKey == '/not-found'),
        pathParameters: pathParameters,
        queryParameters: queryParameters);
    print("RouteConfig : ${routeConfig.routeKey}");
    return routeConfig;
  }
